...
```json
{
    ...
    "justificacion_relevancia": "Propone autonomía total en Bolivia, involucrando temas de educación, salud y seguridad",
...
```json
{
    "resultados": [
        {
            "contenido": "Tuto firmó una alianza con Demócratas y el Frente Revolucionario de Izquierda.",
            "tipo_hecho": "ANUNCIO",
        ...
        {
            "contenido": "Tuto propone autonomía total, pasando responsabilidades de educación, salud y seguridad a las regiones y municipios.",
        ...
        {
            "contenido": "Quiroga planteó que después de presentar las candidaturas oficialmente todos los candidatos realicen su declaración jurada de bienes y rentas.",
            "tipo_hecho": "DECLARACION",
            "fecha_ocurrencia_inicio": null,
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "año",
        ...
        {
            "contenido": "Quiroga dijo que solo un debate público de todos los candidatos permitirá a la población ver y escuchar las propuestas que tienen para el caso de que sean gobierno.",
            "tipo_hecho": "DECLARACION",
            "fecha_ocurrencia_inicio": null,
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "año",
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "tipo_periodo": null,
            "fuente_especifica": null,
            "notas_contexto": "Solo para funcionarios públicos, según la ley 2027 Estatuto del Funcionario Público"
        },
        {
            "indicador": "Número de debates públicos entre postulantes a la presidencia",
            "categoria": "electoral",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [],
