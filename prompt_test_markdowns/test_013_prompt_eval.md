...
```json
{
    ...
    "justificacion_relevancia": "La detección de un túnel subterráneo en una cárcel de Guatemala impide una posible fuga",
    "categorias_asignadas": [
        "Justicia/Legal",
        "Conflicto/Seguridad"
    ],
    "explicacion_concisa": "La Dirección General del Sistema Penitenciario de Guatemala detectó un túnel subterráneo en la cárcel de Puerto Barrios, donde reos intentaban fugarse. La Policía Nacional Civil impidió la fuga y arrestó a los responsables."
}
```
</details>
...
```json
{
    "resultados": [
        ...
        {
            "contenido": "Sergio Vela, titular de la Dirección General del Sistema Penitenciario, confirmó la localización del túnel",
        ...
        {
            "contenido": "La Policía Nacional Civil (PNC) informó que el integrante de la banda denominada «Los Falsos Pastores» lideraba el grupo que cavaba el túnel",
            "tipo_hecho": "DECLARACION",
            "fecha_ocurrencia_inicio": "2025-04-14",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "dia",
        ...
        {
            "contenido": "Godoy Trujillo es integrante de «Los Falsos Pastores» y se encuentra recluido por delitos de plagio o secuestro y asociación ilícita",
...
```json
{
    "resultados": [
        ...
        {
            "nombre": "Dirección General del Sistema Penitenciario (DGSP)",
            "tipo": "ORGANIZACION",
            "alias": []
        }
    ]
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "contexto": "Señala sobre su intención de fugarse",
            "fecha_cita": null
        }
    ]
}
...
```json
{
    "resultados": [
        ...
        {
            "indicador": "Número de metros de profundidad excavados en el túnel subterráneo",
            "categoria": "otro",
            "valor_numerico": 3,
            "unidad": "metros",
            "ambito_geografico": [
        ...
        {
            "indicador": "Edad del líder del grupo que intentaba fugarse",
            "categoria": "demográfico",
            "valor_numerico": 51,
            "unidad": "años",
            "ambito_geografico": [
