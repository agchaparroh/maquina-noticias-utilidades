...
```json
{
    ...
    "justificacion_relevancia": "El presidente Abinader anuncia apoyo al Gobierno para víctimas de la tragedia en la discoteca Jet Set",
    "categorias_asignadas": [
        "Política Nacional",
        "Conflicto/Seguridad"
    ],
    "explicacion_concisa": "El presidente Abinader anuncia que el Gobierno dará seguimiento a las víctimas y sus familiares de la tragedia en la discoteca Jet Set, ofreciendo apoyo en salud mental y otras áreas"
}
```
</details>
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 103715, Requested 1773. Please try again in 3.2932s. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "contexto": "En un testimonio sobre su experiencia en la tragedia en la discoteca Jet Set",
            "fecha_cita": null
        }
    ]
}
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 103794, Requested 1640. Please try again in 3.260399999s. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
