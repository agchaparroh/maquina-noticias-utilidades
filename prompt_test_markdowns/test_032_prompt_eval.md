...
```json
{
    ...
    "justificacion_relevancia": "Denuncia de la consolidación de un régimen autoritario en Nicaragua y pide ayuda internacional",
    "categorias_asignadas": [
        "Política Nacional",
        "Conflicto/Seguridad",
        "Justicia/Legal"
    ],
    "explicacion_concisa": "La CIDH denuncia la consolidación de un régimen autoritario en Nicaragua y pide ayuda internacional, condenando la represión estatal y la violación de derechos humanos en el país"
}
```
</details>
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 106019, Requested 2233. Please try again in 4.9512s. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
```json
{
    "resultados": [
        ...
        {
            "nombre": "Organismo Interamericano de Derechos Humanos",
            "tipo": "ORGANIZACION",
            "alias": [
                "OEA"
            ]
        ...
        {
            "nombre": "Elecciones Generales Nicaragua 2007",
            "tipo": "EVENTO",
            "alias": []
        },
        {
        ...
        {
            "nombre": "Protestas en Nicaragua 2018",
            "tipo": "EVENTO",
            "alias": []
        },
        {
            "nombre": "Constitución de Nicaragua",
            "tipo": "NORMATIVA",
            "alias": []
        },
        {
            "nombre": "Reformas constitucionales en Nicaragua 2023",
            "tipo": "NORMATIVA",
            "alias": []
        }
    ]
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "emisor_nombre": "Comisión Interamericana de Derechos Humanos (CIDH)",
            "contexto": "Alertó ese organismo autónomo de la OEA",
            "fecha_cita": null
        }
    ]
}
...
```json
{
    "resultados": [
        ...
        {
            "indicador": "Número de organizaciones de la sociedad civil canceladas arbitrariamente en Nicaragua",
            "categoria": "social",
            "valor_numerico": 5441,
        ...
        {
            "indicador": "Número de personas privadas de libertad en condiciones contrarias a la dignidad humana en Nicaragua",
            "categoria": "demográfico",
            "valor_numerico": 42,
            "unidad": "personas",
            "ambito_geografico": [
