...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 100208, Requested 1246. Please try again in 872.8ms. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 96043, Requested 5142. Please try again in 710.8ms. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
```json
{
    "resultados": [
        ...
        {
            "cita": "Porque llegaríamos a un punto de desacato del presidente, un abierto desacato del presidente de una sentencia de la Corte Suprema",
            "emisor_nombre": "Juan Pappier",
            "contexto": "En entrevista con El Diario de Hoy",
            "fecha_cita": null
        },
        {
            "cita": "Del régimen de Maduro no hay que esperar. Este es el mismo régimen que tiene detenidos a cientos de presos políticos en su país",
            "emisor_nombre": "Juan Pappier",
            "contexto": "En entrevista con El Diario de Hoy",
            "fecha_cita": null
        },
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 96113, Requested 5001. Please try again in 668.2ms. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
