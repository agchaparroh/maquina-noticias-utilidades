...
```json
{
    ...
    "explicacion_concisa": "El Partido Popular utiliza inteligencia artificial y big data para analizar tendencias electorales y adaptar sus discursos para captar votos en las próximas elecciones generales"
}
```
</details>
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 100295, Requested 2439. Please try again in 1.640399999s. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "emisor_nombre": "PP",
            "contexto": "Señalando el tema que el PP testó recientemente",
            "fecha_cita": null
        },
        {
            ...
            "emisor_nombre": "PP",
            "contexto": "Señalando algunas de las cuestiones que se han examinado en la Unidad de Análisis de Datos y Prospectiva",
            "fecha_cita": null
        },
        {
            ...
            "contexto": "Describiendo el entorno en el que el partido quiere llegar al sector del campo",
            "fecha_cita": null
        },
        {
            "cita": "detectar las narrativas de desinformación para que los dirigentes y portavoces del partido huyan de ellas",
            "emisor_nombre": "PP",
            "contexto": "Señalando la importancia de evitar las 'fake news'",
            "fecha_cita": null
        }
    ]
}
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 100271, Requested 2304. Please try again in 1.5454s. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
