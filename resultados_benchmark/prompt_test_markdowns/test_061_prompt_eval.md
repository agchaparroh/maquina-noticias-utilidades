...
|-------|--------|--------|--------|--------|-------|
| relevancia | ✅ | `llama3-8b-8192` | 0m 0.54s | 1120.0 | 0.12 |
| extraccion_hechos | ✅ | `llama3-8b-8192` | 0m 1.01s | 2178.0 | 0.18 |
| extraccion_entidades | ✅ | `llama3-8b-8192` | 0m 1.29s | 1340.0 | 0.14 |
| extraccion_citas | ✅ | `llama3-8b-8192` | 0m 0.95s | 1328.0 | 0.22 |
| extraccion_datos | ✅ | `llama3-8b-8192` | 0m 1.89s | 1716.0 | 0.07 |
...
```json
{
    ...
    "explicacion_concisa": "El exalcalde Daniel Quintero propone cerrar el Congreso y convocar a una constituyente, lo que desata una polémica con el director del DPS, Gustavo Bolívar, quien lo considera una medida de dictadores."
}
```
</details>
    ...
    "resultados": [
        {
            ...
            "contexto": "en una entrevista reciente en la revista Cambio",
            "fecha_cita": null
        },
        {
