...
|-------|--------|--------|--------|--------|-------|
| relevancia | ✅ | `llama3-8b-8192` | 0m 0.62s | 1463.0 | 0.13 |
| extraccion_hechos | ❌ | `llama3-8b-8192` | 0m 6.34s |  | N/A |
| extraccion_entidades | ✅ | `llama3-8b-8192` | 0m 1.80s | 5318.0 | 0.10 |
| extraccion_citas | ✅ | `llama3-8b-8192` | 0m 1.37s | 5287.0 | 0.11 |
| extraccion_datos | ✅ | `llama3-8b-8192` | 0m 9.14s | 6123.0 | 0.16 |
...
```json
{
    ...
    "explicacion_concisa": "La organización Human Rights Watch critica la posible creación de un centro de detención similar a Guantánamo en El Salvador, considerando que violaría derechos humanos y generaría crisis institucionales. El subdirector de la organización llama a la comunidad centroamericana a rechazar esta iniciativa y a los gobiernos a oponerse a ella."
}
```
</details>
...
❌ **Estado:** Fallo (Error API)
   ...
   **Mensaje Error:** `API_Error: RateLimitError: Error code: 429 - {'error': {'message': 'Rate limit reached for model `llama3-8b-8192` in organization `org_01jsay2bafeeht06zsq8qv9mct` service tier `on_demand` on tokens per minute (TPM): Limit 100000, Used 95751, Requested 5399. Please try again in 689.799999ms. Need more tokens? Visit https://groq.com/self-serve-support/ to request higher limits.', 'type': 'tokens', 'code': 'rate_limit_exceeded'}}`
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 1.37s
- **Tokens prompt:** 4754.0
- **Tokens respuesta:** 533.0
- **Total tokens:** 5287.0
...
```json
{
    "resultados": [
        ...
        {
            "cita": "Lo que quieren crear es un agujero negro donde no rige la protección de los derechos humanos",
            "emisor_nombre": "Juan Pappier",
            "contexto": "En entrevista con El Diario de Hoy",
            "fecha_cita": null
        },
...
```json
{
    "resultados": [
        {
            "indicador": "Desapariciones forzadas en El Salvador",
            ...
            "notas_contexto": "Desapariciones forzadas de personas migrantes en El Salvador"
        },
        {
            ...
            "periodo_referencia_fin": null,
            "tipo_periodo": null,
            "fuente_especifica": "Gobierno de Estados Unidos",
            "notas_contexto": "Deportaciones de personas migrantes a El Salvador"
        },
        {
            "indicador": "Caso de Kilmar Ábrego",
            "categoria": "electoral",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
            ...
            "periodo_referencia_fin": null,
            "tipo_periodo": null,
            "fuente_especifica": "Corte Suprema de Estados Unidos",
            "notas_contexto": "Caso de Kilmar Ábrego y la orden judicial de la Corte Suprema"
        },
        {
            "indicador": "Número de personas detenidas en centros migratorios de Estados Unidos",
            "categoria": "demográfico",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
            ...
            "tipo_periodo": null,
            "fuente_especifica": "Gobierno de Estados Unidos",
            "notas_contexto": "Detenidos en centros migratorios de Estados Unidos"
        },
        {
            "indicador": "Caso de la organización Human Rights Watch",
            "categoria": "social",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
            ...
            "tipo_periodo": null,
            "fuente_especifica": "Human Rights Watch",
            "notas_contexto": "Investigación de Human Rights Watch sobre desapariciones forzadas en El Salvador"
        },
        {
            ...
            "tipo_periodo": null,
            "fuente_especifica": "Gobierno de Estados Unidos",
            "notas_contexto": "Personas enviadas al CECOT"
        },
        {
            "indicador": "Caso de la organización OIM",
            "categoria": "social",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
            ...
            "periodo_referencia_fin": null,
            "tipo_periodo": null,
            "fuente_especifica": "OIM",
            "notas_contexto": "Rol de la OIM en la migración venezolana"
        }
    ]
}
```
