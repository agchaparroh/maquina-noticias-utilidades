...
|-------|--------|--------|--------|--------|-------|
| relevancia | ✅ | `llama3-8b-8192` | 0m 0.78s | 1391.0 | 0.10 |
| extraccion_hechos | ✅ | `llama3-8b-8192` | 0m 2.00s | 4466.0 | 0.24 |
| extraccion_entidades | ✅ | `llama3-8b-8192` | 0m 2.38s | 3513.0 | 0.19 |
| extraccion_citas | ✅ | `llama3-8b-8192` | 0m 1.56s | 3952.0 | 0.38 |
| extraccion_datos | ✅ | `llama3-8b-8192` | 0m 1.10s | 3863.0 | 0.14 |
...
```json
{
    ...
    "justificacion_relevancia": "Relevancia media por la reunión entre dos líderes mundiales y el tema de seguridad y crimen",
    "categorias_asignadas": [
        "Política Internacional",
        "Conflicto/Seguridad"
    ],
    "explicacion_concisa": "El presidente salvadoreño Nayib Bukele visitó la Casa Blanca y se reunió con Donald Trump, donde ambos líderes elogiaron mutuamente y hablaron sobre la lucha contra el crimen y la seguridad en sus respectivos países."
}
```
</details>
...
```json
{
    "resultados": [
        {
            "contenido": "La visita del presidente salvadoreño Nayib Bukele a la Casa Blanca y su reunión con el presidente estadounidense Donald Trump.",
            "tipo_hecho": "SUCESO",
        ...
        {
            "contenido": "El presidente Trump elogió a Bukele y dijo que El Salvador es el país más seguro del mundo.",
        ...
        {
            "contenido": "Bukele dijo que El Salvador ha liberado a millones de personas y que no hay criminales en prisión.",
            "tipo_hecho": "DECLARACION",
            "fecha_ocurrencia_inicio": "2025-04-14T00:00:00Z",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
        ...
        {
            "contenido": "Trump dijo que Estados Unidos ha deportado a 288 personas acusadas de ser miembros del Tren de Aragua y la pandilla MS-13.",
            "tipo_hecho": "SUCESO",
            "fecha_ocurrencia_inicio": "2025-04-14T00:00:00Z",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
        ...
        {
            "contenido": "Trump dijo que quiere deportar a tantos delincuentes ilegales como sea posible a El Salvador.",
            "tipo_hecho": "DECLARACION",
            "fecha_ocurrencia_inicio": "2025-04-14T00:00:00Z",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 2.38s
- **Tokens prompt:** 2953.0
- **Tokens respuesta:** 560.0
- **Total tokens:** 3513.0
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 1.56s
- **Tokens prompt:** 2865.0
- **Tokens respuesta:** 1087.0
- **Total tokens:** 3952.0
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 1.10s
- **Tokens prompt:** 3384.0
- **Tokens respuesta:** 479.0
- **Total tokens:** 3863.0
...
```json
{
    "resultados": [
        ...
        },
        {
            ...
            "notas_contexto": "Estimación no cuantificada"
        },
        {
        ...
        {
            "indicador": "Número de personas que Bukele no quiere liberar en El Salvador",
            "categoria": "demográfico",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
