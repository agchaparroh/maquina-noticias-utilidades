...
|-------|--------|--------|--------|--------|-------|
| relevancia | ✅ | `llama3-8b-8192` | 0m 0.64s | 1378.0 | 0.10 |
| extraccion_hechos | ✅ | `llama3-8b-8192` | 0m 4.06s | 4144.0 | 0.45 |
| extraccion_entidades | ✅ | `llama3-8b-8192` | 0m 2.01s | 2455.0 | 0.12 |
| extraccion_citas | ✅ | `llama3-8b-8192` | 0m 1.16s | 2482.0 | 0.18 |
| extraccion_datos | ✅ | `llama3-8b-8192` | 0m 1.44s | 3125.0 | 0.19 |
...
```json
{
    ...
    "justificacion_relevancia": "Relevante por su impacto en la supervisión de obras públicas y privadas en República Dominicana",
    "categorias_asignadas": [
        "Economía",
        "Justicia/Legal"
    ],
    "explicacion_concisa": "El senador Pedro Tineo presenta un proyecto de ley para crear un sistema de supervisión y certificación de obras públicas y privadas en República Dominicana, con el objetivo de garantizar la seguridad estructural y proteger la vida humana."
}
```
</details>
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 4.06s
- **Tokens prompt:** 2859.0
- **Tokens respuesta:** 1285.0
- **Total tokens:** 4144.0
...
```json
{
    "resultados": [
        ...
        {
            "contenido": "El proyecto de ley crea el Sistema Nacional de Supervisión y Certificación de Obras Públicas y Privadas con más de diez años de construcción, como mecanismo de evaluación periódica, certificación técnica y prevención de riesgos estructurales.",
            "tipo_hecho": "CONCEPTO",
            "fecha_ocurrencia_inicio": "2025-04-14",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
        ...
        {
            "contenido": "El proyecto de ley crea la Dirección Ejecutiva del Sistema Nacional de Supervisión y Certificación de Obras Públicas y Privadas (Sinasco) como órgano técnico-operativo encargado de ejecutar las funciones administrativas, técnicas, de supervisión y certificación del Sistema.",
            "tipo_hecho": "SUCESO",
            "fecha_ocurrencia_inicio": "2025-04-14",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
        ...
        {
            "contenido": "El proyecto de ley establece que las obras comprendidas en esta ley deberán ser inspeccionadas cada dos (2) años a partir de la fecha de su primera evaluación.",
            "tipo_hecho": "SUCESO",
            "fecha_ocurrencia_inicio": "2025-04-14",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
        ...
        {
            "contenido": "El proyecto de ley establece que el propietario o administrador de una edificación comprendida en esta ley deberá facilitar el acceso para inspección, acoger las recomendaciones emitidas y realizar las correcciones que se le indiquen.",
            "tipo_hecho": "SUCESO",
            "fecha_ocurrencia_inicio": "2025-04-14",
            "fecha_ocurrencia_fin": null,
            "precision_temporal": "exacta",
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 2.01s
- **Tokens prompt:** 2194.0
- **Tokens respuesta:** 261.0
- **Total tokens:** 2455.0
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 1.16s
- **Tokens prompt:** 2106.0
- **Tokens respuesta:** 376.0
- **Total tokens:** 2482.0
...
- **Modelo:** `llama3-8b-8192`
- **Tiempo:** 0m 1.44s
- **Tokens prompt:** 2625.0
- **Tokens respuesta:** 500.0
- **Total tokens:** 3125.0
...
```json
{
    "resultados": [
        {
            "indicador": "Edificios con más de 10 años de construcción",
            ...
            "notas_contexto": "Edificios públicos y privados con más de 10 años de construcción"
        },
        {
            "indicador": "Frecuencia de supervisión de obras",
            "categoria": "presupuestario",
            "valor_numerico": 2,
            "unidad": "años",
            "ambito_geografico": [
            ...
            "tipo_periodo": null,
            "fuente_especifica": null,
            "notas_contexto": "Obras comprendidas en la ley"
        },
        {
            "indicador": "Frecuencia de supervisión en zonas de riesgo",
            "categoria": "presupuestario",
            "valor_numerico": null,
            "unidad": null,
            "ambito_geografico": [
            ...
            "tipo_periodo": null,
            "fuente_especifica": null,
            "notas_contexto": "Zonas vulnerables a fenómenos sísmicos, deslizamientos o impactos ambientales"
        },
        {
            "indicador": "Multas administrativas",
            "categoria": "presupuestario",
            "valor_numerico": 50000,
            "unidad": "salarios mínimos del sector público",
            "ambito_geografico": [
                "República Dominicana"
            ],
            "periodo_referencia_inicio": null,
            ...
            "tipo_periodo": null,
            "fuente_especifica": null,
            "notas_contexto": "Multas administrativas por incumplimiento de la ley"
        }
    ]
}
```
