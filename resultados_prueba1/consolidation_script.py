...
Versión modificada para trabajar con la carpeta resultados_prueba1.
"""
import os
import json
import time
...
# --- Configuración ---
# Directorios (Ajustados para resultados_prueba1)
INPUT_ARTICLES_DIR = Path("/home/ubuntu/data/benchmark_test_set")
INPUT_RESULTS_DIR = Path("/home/ubuntu/benchmark_utils/resultados_prueba1/prompt_test_results")
OUTPUT_MARKDOWN_DIR = Path("/home/ubuntu/benchmark_utils/resultados_prueba1/prompt_test_markdowns")
